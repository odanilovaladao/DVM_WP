...
const TicketAdvanced = (props) => {
	...
	const renderMessageContext = () => {
        ...
        return renderTicketsManagerTabs();
	...
	return (
        <TicketAdvancedLayout>
            <Box className={classes.header} style={{display: 'none'}}>
                <BottomNavigation
                    value={option}
                    ...
                    style={{display: 'none'}}
                >
                    <BottomNavigationAction label="Ticket" icon={<ChatIcon style={{position:'absolute', left: 20}} />} />
                    <BottomNavigationAction label="Atendimentos" icon={<QuestionAnswerIcon style={{position:'absolute', right: 0}} />} />
                </BottomNavigation>
            </Box>
