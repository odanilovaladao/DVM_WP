...
import FinallyMessageModal from "../../components/FinallyMessageModal";
...
const FinallyMessage = () => {
  ...
  useEffect(() => {
    ...
    socket.on(`company-ticketStatus`, (data) => {
  ...
  const fetchAnnouncements = async () => {
    const companyId = localStorage.getItem("companyId");
    try {
      const { data } = await api.get("/tickets-status/", {
  ...
  const handleDeleteAnnouncement = async (announcementId) => {
    try {
      await api.delete(`/tickets-status/${announcementId}`);
            ...
            <>
              {announcements.map((announcement) => (
                <TableRow key={announcement.id}>
                  ...
                  {/*<TableCell align="center">{announcement.text}</TableCell>*/}
                  <TableCell align="center">
